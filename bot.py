...
def credit():
    ...
    print(Fore.BLUE +"                              |                                                                                      |")
    print(Fore.BLUE +"                              |" + Fore.RESET +"                Discord : Cp.set#9111" + Fore.BLUE + "                                                  |")
    print(Fore.BLUE +"                              |" + Fore.RESET +"                Github : https://github.com/Cpset" + Fore.BLUE + "                                  |")
    print(Fore.BLUE +"                              |" + Fore.RESET +"                steam : https://steamcommunity.com/id/607835/" + Fore.BLUE + "                  |")
    print(Fore.BLUE +"                              |                                                                                      |")
    print(Fore.BLUE +"                              |" + Fore.RESET +"                Discord server invite link :" + Fore.BLUE + "                                          |")
    print(Fore.BLUE +"                              |" + Fore.RESET +"               https://discord.gg/KqYuetCR" + Fore.BLUE + "                                  |")
    print(Fore.BLUE +"                              |                                                                                      |")
    print(Fore.BLUE +"                             [*]=----------------------------------------------------------------------------------=[*]")
    print("")
    input("")
